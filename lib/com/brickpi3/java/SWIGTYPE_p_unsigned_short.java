...
public class SWIGTYPE_p_unsigned_short extends SWIG {
  ...
  boolean equal = false;
  if (obj instanceof SWIGTYPE_p_unsigned_short)
    equal = (((SWIGTYPE_p_unsigned_short)obj).swigCPtr == this.swigCPtr);
  return equal;
  }
  public int hashCode() {
    return (int)swigCPtr;
